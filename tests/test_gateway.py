...
from core.gateway import TOOL_CONTRACTS
from core.schemas import Decision, GatewayState, ProposedAction, RunContext
...
def test_forbidden_op(ctx, state, monkeypatch):
    monkeypatch.setitem(TOOL_CONTRACTS, "records.delete", {"capability": "crm.write", "fields": {"id"}, "money": False})
