...
def base_seed(
    *, amount_cents: int = 4200, duplicate_customer: bool = False, already_refunded: bool = False
) -> dict[str, Any]:
    """Canonical provider seed used by most scenarios."""
    customers = [{"id": "cus_acme", "email": "jane@acme.com", "name": "Jane Doe", "tenant_id": TENANT}]
    if duplicate_customer:
        customers.append(
            {"id": "cus_acme2", "email": "jane@acme.com", "name": "Jane Doe", "tenant_id": TENANT}
        )
    charges = [
...
SCENARIOS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "action": {
            "tool": "stripe.refund",
            "params": {"tenant_id": "t_evil", "charge_id": "ch_100", "amount_cents": 1000},
        },
    ...
    },
    {
        ...
        "action": {
            "tool": "stripe.refund",
            "params": {"charge_id": "ch_100", "amount_cents": 2000, "reason": "duplicate"},
        },
